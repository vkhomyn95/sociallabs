...
public class TelegramBotStickerResourceHandler extends TelegramBotBaseResourceHandler {
    ...
    public static Map<String, Object> execute(
        ...
        return switch (params.getOperation()) {
            case SEND -> executeSendSticker(client, botToken, params, item);
     ...
     */
    private static Map<String, Object> executeSendSticker(
            WebClient client,
            String botToken,
            TelegramBotActionParameters params,
            Map<String, Object> item
        ...
        return sendTelegramRequest(client, botToken, TelegramResourceKeys.SEND_STICKER, body, params);
    }
}
